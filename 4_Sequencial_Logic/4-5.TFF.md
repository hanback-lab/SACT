...
<br>
<img src="./pds/t02.png" alt="p02" style="width: 60%;"><br>
<br>
...
9. 컴파일 완료 후, File > Open 메뉴를 선택하고, 나타나는 Open File 창에서 오른쪽 아래 부분의 File Type을 All File(*.*)로 변경한 후, Waveftm.vwf 파일을 선택한다. 

10. 아래 그림과 같이 Waveftm 창에서, Simulation > Run Functiona Simulation 메뉴를 선택하여 Functional Simulation을 진행하여, 결과를 확인한다. 
