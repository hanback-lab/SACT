...
8. (a) TC의 심볼을 불러오면 아래 그림과 같은 형태가 보이는데, 실험헤서 사용하기 위해서는 TC에서 사용한 CNT10의 출력이 필요하다. 그러므로, 다음과 같이 TC.bdf 파일을 열어서 출력 포트를 추가한다. 
...
8. (b) File > Create / Update > Create Symbol Files for Current File 메뉴를 선택하여 TC 심볼을 다시 생성하고, 도면에 배치한다. 
