...
<img src="./pds/tf01aa.png" alt="p03" style="width: 100%;"><br>

<img src="./pds/tf01ba.png" alt="p03" style="width: 100%;"><br>

<img src="./pds/tf01ca.png" alt="p03" style="width: 30%;">
...
1. 타이머 및 State 블록
    ...
    - TIMER[3]이 Falling Edge인 것에 의해 7493이 카운트 된다. 즉, TRAFFIC에서 0-9까지 카운트 될때 마다 7490이 카운트 되서 S[1..0]이 00, 01, 10, 11 카운트 된다. <br>
...
3. RED LED 제어
    ...
    <img src="./pds/tf01ca.png" alt="p03" style="width: 30%;"><br>
...
9. TC의 심볼을 불러오면 아래 그림과 같은 형태가 보이는데, 실험헤서 사용하기 위해서는 TC에서 사용한 CNT10의 출력이 필요하다. 그러므로, 다음과 같이 TC.bdf 파일을 열어서 출력 포트를 추가한다. 

    <img src="./pds/tf01a-1.png" alt="p03" style="width: 40%;">
    <img src="./pds/tf01a-2.png" alt="p03" style="width: 100%;">
    <img src="./pds/tf01a-3.png" alt="p03" style="width: 30%;">

10. File > Create / Update > Create Symbol Files for Current File 메뉴를 선택하여 TC 심볼을 다시 생성하고, 도면에 배치한다. 

    <img src="./pds/tf01a-4.png" alt="p03" style="width: 100%;">


11. 다음 그림과 같이 input과 output의 이름을 수정하고, 그외 회로를 완성시키는데 필요한 심볼들을 추가해 심볼 사이를 wire로 연결하여 도면을 완성시킨다. 

    <img src="./pds/tf01aa.png" alt="p03" style="width: 100%;">
    <img src="./pds/tf01ba.png" alt="p03" style="width: 100%;">
    <img src="./pds/tf01ca.png" alt="p03" style="width: 50%;">

12. Save 한다. 이 때, 파일명을 Project 명(기본 설정, TRAFFIC)으로 설정한다. 
...
21. Simulation > Run Functional Simulation 메뉴를 선택하여 시뮬레이션을 진행한다. 
   ...
   <img src="./pds/tf04a.png" alt="traffic" style="width: 100%;"><br><br>
...
31. 장비 중앙의 CLOCK 설정 블록에서 CLOCK SELECT SWITCH를 돌려 1Hz로 설정하고, 신호등에서의 동작을 확인해 보자. 
...
32. 신호등의 동작을 다양화 해보자. 특정 신호의 입력이 들어오면 모든 노란불이 깜빡이는 회로를 설계해보자. 
