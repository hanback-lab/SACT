...
반감산기는 두 개의 입력 비트(A, B)의 차 D(Difference)와 빌려오는 수를 BO(Borrow)를 산출하는 논리 회로인데, 다음은 반감산기의 진리표를 나타낸 것이다. 
...
1. 실험을 위해 프로젝트 파일 <a href="./pds/HS.zip" download>HS.zip</a>을 준비한다. 
<br>
